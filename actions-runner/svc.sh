...
SVC_NAME="actions.runner.pedro-carrasco-4.2.Integracion-y-entrega-continua-ejem-1.mca"
SVC_NAME=${SVC_NAME// /_}
SVC_DESCRIPTION="GitHub Actions Runner (pedro-carrasco-4.2.Integracion-y-entrega-continua-ejem-1.mca)"
